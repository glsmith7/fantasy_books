...
def connect_to_database(path):
    ...
    PARENT_DIRECTORY_OF_CURRENT_SCRIPT = os.path.realpath(os.path.join(os.path.dirname(__file__), '..'))
    SQL_DATABASE_LOCATION = os.path.join((PARENT_DIRECTORY_OF_CURRENT_SCRIPT), path)
